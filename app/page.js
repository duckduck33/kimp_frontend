    ...
    <>
      ...
      <NavBar /> {/* 여기! 상단 메뉴 항상 노출 */}
        ...
        <h1 style={{ fontSize: '2.2rem', marginBottom: '1rem', textAlign: 'center' }}>
          포비트 실시간 김프(업비트 ↔ 바이비트) 모니터링
        </h1>
        
        {/* SEO를 위한 숨겨진 텍스트 */}
        <div style={{ display: 'none' }}>
          <h2>포비트앱 암호화폐 자동매매 플랫폼</h2>
          <p>포비트는 업비트와 바이비트 간의 실시간 김프율을 모니터링하여 차익거래 기회를 제공하는 암호화폐 자동매매 플랫폼입니다. 포비트앱을 통해 스마트한 암호화폐 투자를 시작하세요.</p>
          <p>포비트 주요 기능: 실시간 김프 모니터링, RSI 히트맵 분석, 경제캘린더, 골든타임 자동매매, 트레이딩뷰 자동매매, 알트코인 폭등감시봇, 업비트 상장 감시봇, 바이낸스 상장폐지 감시봇</p>
        </div>
