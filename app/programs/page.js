    ...
    <main style={{ 
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <div style={{ display: 'none' }}>
          <h2>포비트앱 자동매매 프로그램</h2>
          <p>포비트는 암호화폐 자동매매를 위한 다양한 프로그램을 제공합니다. 알트코인 폭등감시봇, 업비트 상장 감시봇, 바이낸스 상장폐지 감시봇, 트레이딩뷰지표 자동매매봇 등 포비트앱의 전문적인 자동매매 솔루션을 만나보세요.</p>
        </div>
        ...
        <div style={{
          ...
          <p style={{
            ...
            각 프로그램은 독립적으로 운영되며, 투자자의 다양한 니즈에 맞춰 설계되었습니다.
          </p>
        </div>
